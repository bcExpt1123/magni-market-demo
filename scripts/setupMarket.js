...
const portfolioCollectionMetadataUrl = "https://ipfs.io/ipfs/QmbWU2oYy1izUThhfMZPdoYk2GKChzWFULv32anCQhqkL7?filename=portfolio"
...
async function setupMarket(marketplaceAddress, collectionAddress, nftAddress) {
  ...
  collectionAddress = collectionAddress || process.env[`COLLECTION_CONTRACT_ADDRESS_${networkName}`]
  ...
  await collectionContract.connect(acc2).createCollection(0, "sample collection", "sec", portfolioCollectionMetadataUrl) // ERC721 collection, collectionId = 4
